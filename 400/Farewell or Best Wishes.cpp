...
bool alabu(v99 a,v99 b,v99 r)
{
    return (r-a)>=0 and (r-a)%b==0;
}

void solve()
{
    /// code is here->
    v99 x,y;read(n,m,x,y);
    if(x==1 or y==m)return print("BestWishes");
    v99 r1=y-1,r2=(x+m)-2;
    v99 start=x-1;
    v99 delay=2*n -2;
    if(alabu(start,delay,r1))return print("BestWishes");
    ...
    start=(m-y);
    delay=2*m-2;
    if(alabu(start,delay,r2))return print("BestWishes");
