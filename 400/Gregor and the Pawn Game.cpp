...
void solve()
{
    /// code is here->
    v99 n;read(n);
    string u,d,ans(n,'0');read(u,d);
    rep0(i,0,n)
    {
        if(d[i]=='1' and u[i]=='0' and ans[i]!='1' )d[i]='0',ans[i]='1';
        else if(d[i]=='1' and i-1>=0 and u[i-1]=='1' and ans[i-1]!='1')d[i]=u[i-1]='0',ans[i-1]='1';
        else if(d[i]=='1' and i+1<n and u[i+1]=='1' and ans[i+1]!='1')d[i]=u[i+1]='0',ans[i+1]='1';
    }
    v99 cr_h=0;
    for(auto i:ans)cr_h+=i=='1';
    print(cr_h);
}
