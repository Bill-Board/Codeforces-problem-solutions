...
void solve()
{
    ...
    if(k==0){alabu();return;}
    string s="11",t="10";
    for(v99 i=1;i<k;i++)s+='0',t+='0';
    s+='0';t+='1';
    for(char i:s)a-=(i=='0'),b-=(i=='1');
    for(v99 i=1;i<=a;i++)s+='0',t+='0';
    for(v99 i=1;i<=b;i++)s+='1',t+='1';

    v99 aa=0,bb=0;
    for(char i:s)aa+=(i=='0'),bb+=(i=='1');
    if(s.size()!=n){print("NO");return;}
    if(aa!=x){print("NO");return;}
    if(bb!=y){print("NO");return;}
    print("YES");
    print(s);print(t);
}
