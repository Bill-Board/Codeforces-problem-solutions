...
v99 n,a[5001],dp[5001][5001];
v99 hoise_to(v99 l, v99 r)
{
    if(l>=r)return 0;
    if(dp[l][r]!=-1)return dp[l][r];
    v99 ans=min(hoise_to(l,r-1)+1,hoise_to(l+1,r)+1);
    if(a[l]==a[r])ans=min(ans,hoise_to(l+1,r-1)+1);
    return dp[l][r]=ans;
}
