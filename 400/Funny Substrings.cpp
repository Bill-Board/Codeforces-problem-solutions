...
akib marge(const akib &a, const akib &b)
{
    akib n;
    n.cnt=a.cnt+b.cnt+countt(a.suf+b.pre);
    n.pre=a.pre+b.pre;
    n.suf=a.suf+b.suf;
    n.katesi();
    return n;
...
void solve()
{
    ...
    rep0(i,0,n)
    {
        ...
        {
            string b,plus,c;read(b,plus,c);
            mpp[a]=marge(mpp[b],mpp[c]);
        }
        if(i==n-1)
        {
            print(mpp[a].cnt);
