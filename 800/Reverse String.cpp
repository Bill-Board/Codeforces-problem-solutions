...
void solve()
{
    ...
    {
        for(v99 rr=1;rr<=t.size();rr++)
        {
            v99 l=t.size()-rr,sz=t.size(),r=rr;
            if(r+i-1 >=n or i+r-l<0)continue;
            bool ok=true;//print(i+1,r,l);
            //print(r+i-1,n,i+r-l);
            for(v99 k=i,e=0;e<t.size();e++)
            {
                //print(k+1,r);
                if(r>0)
                {
