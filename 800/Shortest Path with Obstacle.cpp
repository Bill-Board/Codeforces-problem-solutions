...
{
    /// code is here->
    v99 a,b,c,d,e,f;read(a,b,c,d,e,f);

    if(a!=c and b!=d)return print(abs(a-c)+abs(b-d));
    if(a==c)
    {
        if(e!=a)print(abs(a-c)+abs(b-d));
        else
        {
            if(b>d)swap(b,d);
            if(b<f and f<d)print(abs(a-c)+abs(b-d)+2);
            else print(abs(a-c)+abs(b-d));
        }
    }
    else
    {
        if(f!=b)print(abs(a-c)+abs(b-d));
        else
        {
            if(a>c)swap(a,c);
            if(a<e and e<c)print(abs(a-c)+abs(b-d)+2);
            else print(abs(a-c)+abs(b-d));
        }
    }
}
