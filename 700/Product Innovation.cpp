...
string pr="print",ml="moveLeft",mr="moveRight";
string ir="insertRight",il="insertLeft";
...
void solve()
{
    ...
    while(q--)
    {
        ...
        {
            if(curr->pre!=NULL)curr=curr->pre;
        }
        else if(s==mr)
        {
            if(curr->nxt!=NULL)curr=curr->nxt;
        }
        else if(s==il)
        {
            v99 w;read(w);
