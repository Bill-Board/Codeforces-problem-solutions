...
bool is_ok(v99 st,v99 b,v99 c)
{
    if(b+c==st)return true;
    if(b==c and st%2==0)return true;
    return false;
}
...
void solve()
{
    ...
    {
        v99 b,c;
        if(i==0)if(is_ok(a[i],a[1],a[2]))return print("YES");
        if(i==1)if(is_ok(a[i],a[0],a[2]))return print("YES");;
        if(i==2)if(is_ok(a[i],a[0],a[1]))return print("YES");;
    }
    print("NO");
}
