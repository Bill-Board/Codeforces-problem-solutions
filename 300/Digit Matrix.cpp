...
///-------------------------------------------------------------------------------------------------------
v99 a[102][102],b[102][102],ans[104][104];
v99 ppp(v99 i,v99 j)
{
    v99 cr_h=9LL;
    rep0(k,0,4)cr_h=min(cr_h,b[i+fx[k]][j+fy[k]]);
    rep0(k,0,4)b[i+fx[k]][j+fy[k]]-=cr_h;
    return cr_h;
}
...
void solve()
{
    ...
    rep0(i,0,n)
    {
        rep0(j,0,n)read(a[i][j]),b[i][j]=a[i][j];
    }
    rep0(i,0,n-1)
    {
        rep0(j,0,n-1)
    ...
    rep1(i,0,n){rep1(j,0,n)cout<<ans[i][j]<<whp;cout<<ses;}
    rep0(i,0,n){rep0(j,0,n)cout<<b[i][j]<<whp;cout<<ses;}
    priority_queue< pair<v99,pii > >q;
