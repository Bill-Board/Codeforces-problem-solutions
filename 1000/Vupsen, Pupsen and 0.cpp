...
void solve()
{
    ...
    if(n&1)
    {
        if(a[0]+a[1]!=0)cout<<-a[2]<<whp<<-a[2]<<whp<<a[0]+a[1]<<whp;
        else if(a[0]+a[2]!=0)cout<<-a[1]<<whp<<a[0]+a[2]<<whp<<-a[1]<<whp;
        else cout<<a[1]+a[2]<<whp<<-a[0]<<whp<<-a[0]<<whp;

        for(v99 i=3;i<n;i+=2)cout<<-a[i+1]<<whp<<a[i]<<whp;
    }
    else for(v99 i=0;i<n;i+=2)cout<<-a[i+1]<<whp<<a[i]<<whp;
    cout<<ses;
}
